...
import 'package:tindev/data/explore_json.dart';
...
class _ExplorePageState extends State<ExplorePage>
  ...
  bool checkFocus =
      true; //check coi có đang focus để hiện hay không hiện like/dislike
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          ...
                          Row(
                            children:
                                List.generate(itemsTemp[index]['skills'].length,
                                    (indexLikes) {
                              if (indexLikes == 0) {
                                return Padding(
