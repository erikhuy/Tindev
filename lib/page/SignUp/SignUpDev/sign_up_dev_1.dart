...
import 'package:tindev/page/SignUp/SignUpDev/sign_up_dev_2.dart';
import 'package:tindev/services/CityServices.dart';

class SignUpDev1 extends StatefulWidget {
  @override
  _SignUpDev1State createState() => _SignUpDev1State();
}

class _SignUpDev1State extends State<SignUpDev1> {
  ...
  void initState() {
    ...
    //account mẫu
    // emailController.text = "testDev@gmail.com";
